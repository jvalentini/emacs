...
(defun my-ruby-mode-hook ()
  ...
  (define-key ruby-mode-map (kbd "C-c p t") 'rspec-toggle-spec-and-target)
...
(require 'guide-key)
(setq guide-key/guide-key-sequence '("C-x r" "C-x /" "C-x a" "C-c p" "C-c C-x" "C-c /" "C-c C-o" "C-c" "C-c C-d" "C-c h" "C-c !" "C-c ,"))
(guide-key-mode 1)
